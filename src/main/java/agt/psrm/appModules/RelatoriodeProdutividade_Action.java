...
public class RelatoriodeProdutividade_Action {
    ...
    public static void Execute(int iTestCaseRow) throws Exception{
    	...
    	CollectionReport_Page.RelatoriodeProdutividade_CollectionReport().click();
    	Log.info("RelatoriodeProdutividade Navigation has been clicked");
