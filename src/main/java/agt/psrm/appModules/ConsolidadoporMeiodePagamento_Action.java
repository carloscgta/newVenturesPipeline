...
public class ConsolidadoporMeiodePagamento_Action {
    ...
    public static void Execute(int iTestCaseRow) throws Exception{
    	...
    	CollectionReport_Page.RelatorioConsolidadoporMeiodePagamento_CollectionReport().click();
    	Log.info("RelatorioConsolidadoporMeiodePagamento Navigation has been clicked");
        ...
        Select RegiaoTributária_CollectionReport = new Select(CollectionReport_Page.RegiaoTributaria_CollectionReport());
        String RegiaoTributária = ExcelUtils.getCellData(iTestCaseRow, Constant.Col_RegiaoTributaria);
        RegiaoTributária_CollectionReport.selectByVisibleText(RegiaoTributária);
        Log.info(RegiaoTributária+" value has been selected in dropdown" );
        ...
        Select EntidadeArrecadadora_CollectionReport = new Select(CollectionReport_Page.EntidadeArrecadadora_CollectionReport());
        String EntidadeArrecadadora = ExcelUtils.getCellData(iTestCaseRow, Constant.Col_EntidadeArrecadadora);
        EntidadeArrecadadora_CollectionReport.selectByVisibleText(EntidadeArrecadadora);
        Log.info(EntidadeArrecadadora+" value has been selected in dropdown" );
