...
public class PesquisadePagamentos_Page extends BaseClass{
    private static WebElement element = null;
   
public PesquisadePagamentos_Page(WebDriver driver){
    	super(driver);
} 
...
public static WebElement PesquisadePagamentos() throws Exception{
    try{
    	element = driver.findElement(By.xpath("//span[text()='Pesquisa de Pagamentos/Metodos de Pagamento']"));
    
        Log.info("Pesquisa de Pagamentos/Metodos de Pagamento Navigation is found");
    }catch (Exception e){
    	Log.error("Pesquisa de Pagamentos/Metodos de Pagamento Navigation is not found");
   		throw(e);
   		}
   	return element;
} 	
public static WebElement Pesquisar_Pagamentos() throws Exception{
    try{
    	element = driver.findElement(By.id("PAY_SEARCH_FLG"));
        Log.info("Pesquisar dropdown is found");
    }catch (Exception e){
    	Log.error("Pesquisar dropdown is not found");
   		throw(e);
   		}
   	return element;	
} 

public static WebElement ContadePagamentos_dropdown() throws Exception{
    try{
    	element = driver.findElement(By.id("PAY_ACCT_FLTR_FLG"));
        Log.info("Conta de Pagamentos dropdown is found");
    }catch (Exception e){
    	Log.error("SConta de Pagamentos dropdown is not found");
   		throw(e);
   		}
   	return element;	
} 
...
public static WebElement MontantedoMetododePagamento_Dropdown() throws Exception{
    try{
        ...
        Log.info("Montante do Metodo de Pagamento dropdown is found on the Home Page");
    }catch (Exception e){
    	Log.error("Montante do Metodo de Pagamento dropdown is not found on the Home Page");
   		throw(e);
   		}
   	return element;	
} 
...
public static WebElement MontantedoMetododePagamento_Values1() throws Exception{
    try{
        ...
        Log.info("Montante do Metodo de Pagamento Values 1 is found on the Home Page");
    }catch (Exception e){
    	Log.error("Montante do Metodo de Pagamento Values 1 is not found on the Home Page");
   		throw(e);
   		}
   	return element;	
}
...
public static WebElement MontantedoMetododePagamento_Values2() throws Exception{
    try{
        ...
        Log.info("Montante do Metodo de Pagamento Values 2 is found on the Home Page");
    }catch (Exception e){
    	Log.error("Montante do Metodo de Pagamento Values 2 is not found on the Home Page");
   		throw(e);
   		}
   	return element;	
}
...
public static WebElement OrigemdoMetododePagamento_dropdown() throws Exception{
    try{
        ...
        Log.info("Origem do Metodo de Pagamento dropdowns is found on the Home Page");
    }catch (Exception e){
    	Log.error("Origem do Metodo de Pagamento dropdowns is not found on the Home Page");
   		throw(e);
   		}
   	return element;	
} 
...
public static WebElement OrigemdoMetododePagamento_Value() throws Exception{
    try{
        ...
        Log.info("Origem do Metodo de Pagamento Value is found on the Home Page");
    }catch (Exception e){
    	Log.error("Origem do Metodo de Pagamento Value is not found on the Home Page");
   		throw(e);
   		}
   	return element;	
}
