...
public class DetalhadodeLiquidacoesporEstado_Action {
    ...
    public static void Execute(int iTestCaseRow) throws Exception{
    	...
    	CollectionReport_Page.RelatorioDetalhadodeLiquidacoesporEstado_CollectionReport().click();
        ...
        BaseClass.driver.findElement(By.id("generateDetlSettelReport_formAssessment")).click();
