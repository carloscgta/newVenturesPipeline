...
public class DetalhadodeFaltosos_Action {
    ...
    public static void Execute(int iTestCaseRow) throws Exception{
    	...
    	CollectionReport_Page.RelatorioDetalhadodeFaltosos_CollectionReport().click();
        ...
        Select TipodeContribuinte_CollectionReport = new Select(CollectionReport_Page.TipodeContribuinte_CollectionReport());
        String TipodeContribuinte = ExcelUtils.getCellData(iTestCaseRow, Constant.Col_TipoofContribuinte);
        TipodeContribuinte_CollectionReport.selectByVisibleText(TipodeContribuinte);
        Log.info(TipodeContribuinte+" value has been selected in dropdown" );
